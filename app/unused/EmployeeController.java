...
//        Set<String> oldColl =  db.getCollectionNames();
//
...
//    }
//
//    private static DBObject createDBObject(Employee user) {
//        BasicDBObjectBuilder docBuilder = BasicDBObjectBuilder.start();
//
//        docBuilder.append("_id", user.id);
//        docBuilder.append("name", user.name);
//
